...
from sim.common import Laser, LaserState, Receiver, Radar, EoDetector, EoState, Jammer, Uav, util
...
def main():
    ...
    scene.step_handlers.append(StepEvent(entity=uav, evt=lambda e: print('uav: {}'.format(e.position))))
    scene.step_handlers.append(StepEvent(entity=jammer, evt=lambda e: print('jammer: {}'.format(e.power_on))))
    scene.step_handlers.append(StepEvent(entity=eo, evt=lambda e: print('eo: {} - {}'.format(e.state, e.dir))))
    scene.step_handlers.append(StepEvent(entity=laser, evt=lambda e: print('laser: {} - {} - {}'.format(e.state, e.power_on, e.dir))))
